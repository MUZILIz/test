...
export default {
    ...
    methods: {
      ...
      GetProductInfo:function(){
        ...
        let url = 'http://localhost:8080/ssm/Product/GetProductInfo';
           axios.get(url,{params:params},).then(rs => {
                    console.log(rs.data);
                    this.form.id=rs.data.pId
                    this.form.name=rs.data.pName 
                    this.form.pImg=rs.data.pImg
                    this.form.pNum=rs.data.pNum 
                    this.form.price=rs.data.pPrice 
                    this.form.typeId=rs.data.pType
                    this.imageUrl=   rs.data.pImg
                }).catch(error => {
                    console.log(error.data);
                })
      },
      ...
      onSubmit() {
        ...
        let url = 'http://localhost:8080/ssm/Product/update';
